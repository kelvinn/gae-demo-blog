...
var csloadstatustext="<img src='http://media.collegepublisher.com/media/paper960/template/templatemedia/loading.gif' /> Requesting content..." //HTML to indicate Ajax page is being fetched
...
var slidersection= new Array(4)
slidersection[0]="News";
slidersection[1]="Features";
slidersection[2]="Opinion";
slidersection[3]="Sports";
...
/*pcontent+='<a href="#" onClick=\"ContentSlider.turnpage(\''+sliderid+'\', '+i+'); return false\">'+slidersection[i]+'</a> '
